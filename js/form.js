...
var validate = function () {
  ...
  var result = true,
  //Seleccion de que dispositivo se almacena
  ...
  if (!selectTipoDispositivo.val()) {result = false; selectTipoDispositivo.closest('.form-group').addClass('has-error');} else {selectTipoDispositivo.closest('.form-group').addClass('has-success');};
  //Validaciones para Nombres
  if (!inputNombreCompu.val() || inputNombreCompu.val().length > 50) {result = false; inputNombreCompu.closest('.form-group').addClass('has-error');} else {inputNombreCompu.closest('.form-group').addClass('has-success');};
  if (!inputNombreMovil.val() || inputNombreMovil.val().length > 50) {result = false; inputNombreMovil.closest('.form-group').addClass('has-error');} else {inputNombreMovil.closest('.form-group').addClass('has-success');};
  if (!inputNombreOtro.val() || inputNombreOtro.val().length > 50) {result = false; inputNombreOtro.closest('.form-group').addClass('has-error');} else {inputNombreOtro.closest('.form-group').addClass('has-success');};
  //Validaciones para Marca
  if (!inputMarcaCompu.val() || inputMarcaCompu.val().length > 15) {result = false; inputMarcaCompu.closest('.form-group').addClass('has-error');} else {inputMarcaCompu.closest('.form-group').addClass('has-success');};
  if (!inputMarcaMovil.val() || inputMarcaMovil.val().length > 15) {result = false; inputMarcaMovil.closest('.form-group').addClass('has-error');} else {inputMarcaMovil.closest('.form-group').addClass('has-success');};
  if (!inputMarcaOtro.val() || inputMarcaOtro.val().length > 15) {result = false; inputMarcaOtro.closest('.form-group').addClass('has-error');} else {inputMarcaOtro.closest('.form-group').addClass('has-success');};
  //Validaciones para Modelo
  if (!inputModeloCompu.val() || inputModeloCompu.val().length > 15) {result = false;inputModeloCompu.closest('.form-group').addClass('has-error');} else {inputModeloCompu.closest('.form-group').addClass('has-success');};
  if (!inputModeloMovil.val() || inputModeloMovil.val().length > 15) {result = false; inputModeloMovil.closest('.form-group').addClass('has-error');} else {inputModeloMovil.closest('.form-group').addClass('has-success');};
  if (!inputModeloOtro.val() || inputModeloOtro.val().length > 15) {result = false;inputModeloOtro.closest('.form-group').addClass('has-error');} else {inputModeloOtro.closest('.form-group').addClass('has-success');};
  //Validaciones para Activos
  if (!inputActivoCompu.val()) {result = false; inputActivoCompu.closest('.form-group').addClass('has-error');} else {inputActivoCompu.closest('.form-group').addClass('has-success');};
...
/*
  /*
  if (!inputActivoMovil.val()) {result = false; inputActivoMovil.closest('.form-group').addClass('has-error');} else {inputActivoMovil.closest('.form-group').addClass('has-success');};


  if (!inputActivoOtro.val()) {result = false; inputActivoOtro.closest('.form-group').addClass('has-error');} else {inputActivoOtro.closest('.form-group').addClass('has-success');};
  //Validaciones para Selects Sistema
  if (!selectSistemaCompu.val()) {result = false; selectSistemaCompu.closest('.form-group').addClass('has-error');} else {selectSistemaCompu.closest('.form-group').addClass('has-success');};
  if (!selectSistemaMovil.val()) {result = false; selectSistemaMovil.closest('.form-group').addClass('has-error');} else {selectSistemaCompu.closest('.form-group').addClass('has-success');};
  //Validaciones para Selects Tipo
  if (!selecTipoCompu.val()) {result = false; selecTipoCompu.closest('.form-group').addClass('has-error');} else { selecTipoCompu.closest('.form-group').addClass('has-success');};
  if (!selecTipoMovil.val()) {result = false; selecTipoMovil.closest('.form-group').addClass('has-error');} else {selecTipoMovil.closest('.form-group').addClass('has-success');};
  //Validaciones para Pantallas
  if (!inputPantallaCompu.val()) {result = false;inputPantallaCompu.closest('.form-group').addClass('has-error');} else {inputPantallaCompu.closest('.form-group').addClass('has-success');};
  //Validaciones para Soporte
  if (!selectSupportMovil.val()) {result = false;selectSupportMovil.closest('.form-group').addClass('has-error');} else {selectSupportMovil.closest('.form-group').addClass('has-success');};
  //Validaciones para Otro Descripcion
  if (!textDescripcionOtro.val()) {result = false;textDescripcionOtro.closest('.form-group').addClass('has-error');} else {textDescripcionOtro.closest('.form-group').addClass('has-success');};
